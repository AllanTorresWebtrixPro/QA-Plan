...
async function reinsertSettingsTests() {
  console.log('🚀 Re-inserting Settings test cases with subcategory data...');

  try {
    // Step 1: Delete existing Settings tests
    await deleteExistingSettingsTests();

    // Step 2: Get all Settings test files
    ...
    // Step 3: Re-insert all Settings tests with subcategory data
    let totalInserted = 0;
    ...
    console.error('Re-insertion failed:', error);
  }
}

// Run the re-insertion
reinsertSettingsTests().catch(console.error);
