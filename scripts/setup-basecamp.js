...
async function setupBasecamp() {
  console.log("🚀 Basecamp Integration Setup\n");
  ...
  try {
    ...
    console.log("\n📋 Next, we need to find your project and card table IDs.");
    console.log(
    ...
    const clientId = await question("Enter your Basecamp Client ID: ");
    const clientSecret = await question("Enter your Basecamp Client Secret: ");
...
`;
    ...
    console.log(
      "\n⚠️  Important: Make sure .env.local is in your .gitignore file!"
    );
  } catch (error) {
